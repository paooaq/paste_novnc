...
DEFAULT_CONFIGS = {"enter": True, "switch": False, "img": ".//res//Capture.PNG"}
...
class MainView(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Paste APP", pos=wx.DefaultPosition, size=wx.Size(614, 573),
        ...
        self.text_ctrl_cmd = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(400, 150),
                                         wx.TE_MULTILINE)
        self.text_ctrl_cmd.SetToolTip(u"Type here and click paste button")
        ...
        self.checkbox_switch_win = wx.CheckBox(self, wx.ID_ANY, u"Switch", wx.DefaultPosition, wx.DefaultSize, 0)
        self.checkbox_switch_win.SetToolTip(u"")
        ...
        self.m_staticText3 = wx.StaticText(self, wx.ID_ANY, "", wx.DefaultPosition, wx.DefaultSize,
                                           0)
        ...
        self.button_send = wx.Button(self, wx.ID_ANY, u"Paste", wx.DefaultPosition, wx.DefaultSize, 0)
